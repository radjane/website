<template>
  <div class="w-full dark:bg-gray-800 ">
    <div class="mx-auto dark:bg-gray-800 ml-60 mr-60">
      <ol class="relative border-l border-gray-200 dark:border-gray-800  mt-10">
        <li class="mb-10 ml-6">
          <span
        ...
        <li class="mb-10 ml-6" v-for="(e, i) in 10" :key="i">
          <span
            class="flex absolute -left-3 justify-center items-center w-6 h-6 bg-blue-200 rounded-full ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
            <svg class="w-3 h-3 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg">
