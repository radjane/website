...
const localEnabled = process.env.VITE_USE_MOCK || false;
const prodEnabled = process.env.VITE_USE_CHUNK_MOCK || false;
...
export default () => defineConfig({
  plugins: [ //配置需要使用的插件列表
    ...
    viteMockServe({
      ...
      prodEnabled: false,//prodEnabled, // 生产打包开关
  ...
  server: {
    ...
    proxy: {
      ...
      "/test-api": {
        target: "http://www.blackcat.top/website/",
        changeOrigin: true,
